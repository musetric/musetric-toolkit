...
ALIGNMENT_HEADS_MAPPING = {
    ...
    # large-v3 is absent upstream; its substring 'whisper-large' would otherwise
    # wrongly match the v1 heads. Authoritative heads from openai/whisper-large-v3
    # generation_config.json. Must precede 'whisper-large' for the substring match.
    'whisper-large-v3': [[7, 0], [10, 17], [12, 18], [13, 12], [16, 1], [17, 14], [19, 11], [21, 4], [24, 1], [25, 6]],
